namespace ArchNet.Design.Pattern.Factory
{
    ...
    /// author : LOUIS PAKEL
    /// </summary>
    public class ChildModel2 : AbstractModel
    {
        ...
        public ChildModel2(bool pBoolType, int pIntType, double pDoubleType, ushort pUShortType, float pFloatType)
        {
            _stringType = "ChildModel2";
            _boolType = pBoolType;
            _intType = pIntType;

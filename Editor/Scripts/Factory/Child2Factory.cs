namespace ArchNet.Design.Pattern.Factory
{
    ...
    /// author : LOUIS PAKEL
    /// </summary>
    public class Child2Factory : ChildFactory
    {
        ...
        public Child2Factory(bool pBoolType, int pIntType, double pDoubleType, ushort pUShortType, float pFloatType)
        {
            _intType = pIntType;
            _boolType = pBoolType;
        ...
        /// <summary>
        /// Description : Get Model type of ChilModel2
        /// </summary>
        /// <returns></returns>
        public override AbstractModel GetModel()
        {
            return new ChildModel2(_boolType, _intType, _doubleType, _uShortType, _floatType);
        }
    }
}
